...
public interface IUserRepository
{
    ...
    Task<User?> GetByNormalizedEmailAsync(string normalizedEmail, bool includeRoles = false, CancellationToken cancellationToken = default);
    ...
    Task AssignRolesAsync(User user, IReadOnlyCollection<Role> roles, string? assignedBy, CancellationToken cancellationToken = default);
}
